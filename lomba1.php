		...
		<nav class="navbar" id="navbar">
			<div class="container">
				<div class="grid-navbar">
					<a href="index.php" class="nav-logo" title="Premogator.id"><img src="assets/img/logo_small.png"></a>
					<ul class="navbar-nav">
						<li class="nav-item"><a href="index.php#maps" class="nav-link">Lokasi</a></li>
						<li class="nav-item"><a href="index.php#contact" class="nav-link">Kontak</a></li>
						<li class="nav-item"><a href="index.php#lomba" class="nav-link">Perlombaan</a></li>
